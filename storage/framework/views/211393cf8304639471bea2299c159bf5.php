<div id="cart-drawer" class="cd">
    ...
    <aside class="cd-panel">
        ...
        <div class="cd-foot">
            ...
            <a href="<?php echo e(route('checkout.show')); ?>" class="btn cd-checkout">Pokračovať na pokladňu →</a>
            <a href="<?php echo e(route('shop.index')); ?>" class="cd-link" data-cart-close>Pokračovať v nákupe</a>
            <p class="cd-note">Doprava zadarmo od €60. Vzorky ku každej objednávke.</p>
        </div>
    </aside>
</div>
<?php /**PATH /Users/martinachberger/Projects/public/previa/resources/views/partials/cart-drawer.blade.php ENDPATH**/ ?>