<?php $__env->startSection('title', 'Košík - PREVIA'); ?>
...
<section class="cart-page">
    <div id="cart-page-empty" class="cart-empty" style="display:none">
        ...
        <a href="<?php echo e(route('shop.index')); ?>" class="btn">Prejsť do eshopu</a>
    </div>
    <div id="cart-page-content" class="cart-content" style="display:none">
        ...
        <aside class="cart-summary">
            ...
            <a href="<?php echo e(route('checkout.show')); ?>" class="btn cs-cta">Pokračovať na pokladňu →</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/martinachberger/Projects/public/previa/resources/views/pages/cart.blade.php ENDPATH**/ ?>