<?php $__env->startSection('title', 'Filozofia - PREVIA'); ?>
<?php $__env->startSection('description', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.'); ?>

<?php $__env->startSection('content'); ?>

<section class="j-feat j-feat--first">
    <div class="ph" style="background-image:url('<?php echo e(asset('images/redesign/filozofia1.jpg')); ?>')"></div>
    <div class="body">
...
<section class="j-feat">
    <div class="ph" style="background-image:url('<?php echo e(asset('images/redesign/filozofia2.jpg')); ?>')"></div>
    <div class="body">
...
<section class="j-feat">
    <div class="ph" style="background-image:url('<?php echo e(asset('images/redesign/filozofia3.jpg')); ?>')"></div>
    <div class="body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/martinachberger/Projects/public/previa/resources/views/pages/filozofia.blade.php ENDPATH**/ ?>